...
type ProxmoxTemplateStatus struct {
	...
	// InstalledZones is a list of nodes that VM template was prepared.
	// This field is populated by the controller and should not be set manually.
	// +optional
	InstalledZones []string `json:"installedZones,omitempty"`
...
func (in *ProxmoxTemplate) GetInstalledZones() []string {
	return in.Status.InstalledZones
}
...
func (in *ProxmoxUnmanagedTemplate) GetInstalledZones() []string {
	return in.Status.InstalledZones
}
